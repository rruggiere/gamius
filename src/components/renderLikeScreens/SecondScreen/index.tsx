...
import sivir_icon from '../../../assets/zed_iconprofile.png'

import platIcon from '../../../assets/platinumRank.png';
import goldIcon from '../../../assets/goldRank.png';
import adcIcon from '../../../assets/jungleLane.png';
...
export function SecondScreen({ visibleState }: Props) {
        ...
        <View style={styles.container}>
            <View style={styles.containerCard}>
                ...
                <View style={styles.containerProfileName}>
                    <Text style={styles.textUserName}>Reinaldo Ruggiere, 26</Text>
                </View>
                <View style={styles.containerProfileDescription}>
                    <Text style={styles.textUserDescription}>"Jogo jungle e top, busco duo em qualquer lane."</Text>
                </View>
                <View style={styles.containerEloSection}>
                    ...
                    <View style={styles.containerEloFlex}>
                        ...
                        <View><Text style={styles.textDescriptionElo}>Ouro 1</Text></View>
                    </View>
